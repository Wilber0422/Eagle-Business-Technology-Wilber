    ...
    <div className="bg-white dark:bg-slate-950 min-h-screen">
      ...
      <nav className="px-6 md:px-10 lg:px-20 py-8 max-w-[1440px] mx-auto">
        <div className="flex items-center gap-2 text-[10px] md:text-xs font-medium text-slate-400 uppercase tracking-widest">
          ...
          <span className="text-slate-300">/</span>
          <span className="text-slate-600 dark:text-slate-300">AW-Ai-Pop</span>
        </div>
      </nav>
      ...
      <section className="bg-slate-50 dark:bg-slate-900/30 py-24">
        <div className="px-6 md:px-10 lg:px-20 max-w-[1440px] mx-auto">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-display font-bold text-slate-900 dark:text-white mb-12">AW-Ai-Pop Specifications</h2>
      ...
      <section className="py-24 px-6 text-center">
        ...
        <p className="text-slate-500 mb-10">See how the AW-Ai-Pop can streamline your production without breaking the budget.</p>
        <button 
